    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
            <span className="text-2xl font-bold text-blue-600">AetherTrack</span>
          </motion.div>
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          >
            AetherTrack brings order to chaos. Every project. Every team. In perfect sync.
          </motion.p>
  ...
  return (
    <section className="min-h-screen py-24 px-4 flex items-center bg-white dark:bg-gray-900">
      <div className="max-w-6xl mx-auto w-full">
        ...
        >
          See the difference AetherTrack makes
        </motion.p>
...
const testimonials = [
  {
    ...
    company: "TechCorp",
    content: "AetherTrack transformed how our team collaborates. We've cut meeting time by 60% and increased productivity dramatically.",
    rating: 5,
  },
  {
    ...
    <section className="py-24 px-4 bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.p
          ...
          transition={{ delay: 0.2 }}
        >
          Experience the power of AetherTrack
        </motion.p>

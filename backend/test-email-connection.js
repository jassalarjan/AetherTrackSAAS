...
async function testSendEmail(configObj, testEmail) {
  ...
  const mailOptions = {
    from: {
      name: 'AetherTrack Test',
      address: process.env.EMAIL_USER
    },
    to: testEmail,
    subject: '✅ AetherTrack Email Test - SUCCESS',
    text: 'This is a test email from AetherTrack. If you received this, the email service is working correctly!',
    html: `
      <div style="font-family: Arial, sans-serif; padding: 20px; background: #f4f4f4;">
        <div style="background: white; padding: 30px; border-radius: 10px; max-width: 500px; margin: 0 auto;">
          <h2 style="color: #667eea;">✅ AetherTrack Email Test</h2>
          <p>This is a test email from AetherTrack.</p>

...
This document summarizes the comprehensive email template system upgrade for the AetherTrack HR Module.
...
- **Team**: Code Catalyst / AetherTrack Development Team
...
- ✅ HR team can trigger emails from AetherTrack UI
...
**System**: AetherTrack HR Module + Brevo Transactional Email API  
